rule pileup:
    ...
    input:
        ...
        bam = "output/mapping/sorted_bam/{study}/{sample}/{platform}/{run}/{layout}_{strategy}/sample.sorted.bam"
    params:
    ...
    log: "output/logs/variants/pileup/{study}/{sample}/{platform}/{run}/{layout}_{strategy}.txt"
...
rule consensus:
    ...
    output:
        fasta = "output/variants/consensus/{study}/{sample}/{platform}/{run}/{layout}_{strategy}/sample.fasta",
        quality = "output/variants/consensus/{study}/{sample}/{platform}/{run}/{layout}_{strategy}/sample.qual.txt"
    log: "output/logs/variants/consensus/{study}/{sample}/{platform}/{run}/{layout}_{strategy}.txt"
