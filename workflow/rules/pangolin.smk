rule consensus_merge:
    input: build_targets(w, "output/variants/consensus/{study}/{sample}/{platform}/{run}/{layout}_{nfastq}_{strategy}/sample.fasta")
...
rule pangolin_assignment_merge:
    input: build_targets(w, "output/pangolin/pangolin_assignment/{study}/pangolin.csv", ("study_accession",))
